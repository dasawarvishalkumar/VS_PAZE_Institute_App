...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  final _registerModel = RegisterScreenModel();
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      final result = await _registerModel.register(
      ...
      if (result.success) {
        ...
        setState(() => _errorMessage = result.errorMessage ?? 'An error occurred');
      }
    } catch (e) {
